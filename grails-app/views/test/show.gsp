	...
	<body>
		...
		<div id="show-test" class="content scaffold-show" role="main">
			...
			<ol class="property-list test">
				...
				<g:if test="${testInstance?.pruebaEscritura}">
				<li class="fieldcontain">
					<span id="pruebaEscritura-label" class="property-label"><g:message code="test.pruebaEscritura.label" default="Prueba Escritura" /></span>
					
						<span class="property-value" aria-labelledby="pruebaEscritura-label"><g:fieldValue bean="${testInstance}" field="pruebaEscritura"/></span>
